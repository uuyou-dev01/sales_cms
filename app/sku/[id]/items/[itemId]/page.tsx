...
function AdjustStockDialog({ open, onClose, itemId, onSuccess }: AdjustDialogProps) {
...
export default function ItemDetailPage() {
  ...
  const { data, isLoading, refetch } = useItemDetail(itemId)
  ...
  if (!item) {
    return (
      <div className="py-8 text-center">
        <p className="text-gray-500 mb-4">子SKU不存在</p>
